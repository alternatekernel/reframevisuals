...
import { C as LocalImageUsedWrongly, J as UnsupportedImageFormat, O as MissingGetFontFileRequestUrl, S as InvalidImageService, V as RemoteImageNotAllowed, X as AstroError, _ as ImageMissingAlt, c as ExpectedImageOptions, d as FontFamilyNotFound, k as MissingImageDimension, l as ExpectedNotESMImage, q as UnsupportedImageConversion, s as ExpectedImage, v as IncompatibleDescriptorOptions } from "./errors-data_BwmqLQgd.mjs";
import { S as isRemoteAllowed, _ as inferRemoteSize$1, b as isRemoteImage, c as isRemotePath, f as removeQueryString, l as joinPaths, v as fetchWithRedirects, x as resolveSrc, y as isESMImportedImage } from "./path_Dnr0v9iP.mjs";
import { E as createAstro, g as maybeRenderHead, h as renderTemplate, r as spreadAttributes, v as addAttribute, w as unescapeHTML } from "./jsx-runtime_BqAUgf6L.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./build-service_CiNXEtaS.mjs").catch((e) => {
...
}, "F:/Reframe-Visuals-Astro/node_modules/astro/components/Image.astro", void 0);
//#endregion
...
}, "F:/Reframe-Visuals-Astro/node_modules/astro/components/Picture.astro", void 0);
//#endregion
...
}, "F:/Reframe-Visuals-Astro/node_modules/astro/components/Font.astro", void 0);
//#endregion
